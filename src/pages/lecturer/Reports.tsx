...
export const Reports = () => {
  ...
  const createGradient = (ctx: CanvasRenderingContext2D, area: { bottom: number; top: number }) => {
        ...
        <div className="space-y-6">
          <div className="animate-pulse">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="h-96 rounded-lg bg-gray-200 dark:bg-gray-700"></div>
              ))}
            </div>
          </div>
        </div>
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-white/20 bg-white/70 p-6 shadow-xl backdrop-blur-xl dark:border-slate-700/50 dark:bg-slate-900/70">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl border-2 border-gray-200 px-4 py-3 backdrop-blur-sm transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-800/50 dark:text-white"
              />
            </div>
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
        ...
        <Grid numItems={1} numItemsSm={2} numItemsLg={4} className="gap-6">
          <TremorCard className="bg-gradient-to-br from-green-50 to-emerald-100 shadow-xl ring-2 ring-green-200 dark:from-green-950 dark:to-emerald-900 dark:ring-green-800">
            <Flex alignItems="start" className="space-x-4">
              ...
              <div className="flex-1">
                <Text className="font-medium text-green-600 dark:text-green-400">Average Rate</Text>
          ...
          <TremorCard className="bg-gradient-to-br from-blue-50 to-indigo-100 shadow-xl ring-2 ring-blue-200 dark:from-blue-950 dark:to-indigo-900 dark:ring-blue-800">
            <Flex alignItems="start" className="space-x-4">
              ...
              <div className="flex-1">
                <Text className="font-medium text-blue-600 dark:text-blue-400">Total Present</Text>
          ...
          <TremorCard className="bg-gradient-to-br from-red-50 to-rose-100 shadow-xl ring-2 ring-red-200 dark:from-red-950 dark:to-rose-900 dark:ring-red-800">
            <Flex alignItems="start" className="space-x-4">
              ...
              <div className="flex-1">
                <Text className="font-medium text-red-600 dark:text-red-400">Total Absent</Text>
          ...
          <TremorCard className="bg-gradient-to-br from-purple-50 to-violet-100 shadow-xl ring-2 ring-purple-200 dark:from-purple-950 dark:to-violet-900 dark:ring-purple-800">
            <Flex alignItems="start" className="space-x-4">
              ...
              <div className="flex-1">
                <Text className="font-medium text-purple-600 dark:text-purple-400">
                  Total Sessions
                </Text>
